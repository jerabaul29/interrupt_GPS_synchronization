...
class TimeCatcher{
    private:
        static volatile unsigned long measured_time[number_of_interrupt_capable_pins];
        static volatile unsigned long elapsed_time[number_of_interrupt_capable_pins];
